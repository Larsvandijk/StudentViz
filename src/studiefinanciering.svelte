...
<div class="studiefinanciering">
  ...
  <select
    ...
    id="livingsituation"
  >
    <option value="Living at home">I do not live at my own registered adress</option>
    <option value="Living away from home">I live at my own registered adress</option>
  </select>
